  ...
  sections: 
    ...
    - name: Tools/Frameworks
      items:
        - Git, Terminal 
        - Docker, S3, EC2
        - firehose, Athena, Glue
        - lambda, Sagemaker, ECR
        - ML OPS, CI/CD
        - ETL, NIFI
    - name: Education
      items:
...
<!-- have experience in leading and coordinating projects.Experienced in developing and deploying comprehensive data solutions, collaborating with cross-functional teams, and leading innovative projects -->

Dynamic and results-driven researcher with a strong background in neuroscience, statistics, and data science. Proficient in a wide range of programming languages and machine learning frameworks. Dedicated to continuous learning and staying at the forefront of technology trends.



# Experience

\cvevent{10/2022 - Present}{Data Engineer}{Freelancer}
...
\cvevent{04/2022 - 01/2024}{Data Engineer}{FlowBank}
...
-   Jorge Figueiredo,
    [{{< fa envelope >}}](Jorge.figueredo@flowbank.com), **Head of Information Security at FlowBank**
    

-   \href{https://genev.unige.ch/research/people/Jose-Manuel-De-Abreu-Nunes}{\underline{Jose de Abreu Nunes}}
